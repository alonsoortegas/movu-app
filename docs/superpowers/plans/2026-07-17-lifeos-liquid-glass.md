...
- [ ] **Step 1: Write the failing theme-script tests**
...
- [ ] **Step 3: Implement the pure theme script helper**
...
- [ ] **Step 5: Replace global primitives with the Aurora token system**
...
- [ ] **Step 6: Point Tailwind colors and fonts at semantic variables**
...
- [ ] **Step 7: Apply fonts and the pre-paint script in both root layouts**
...
- [ ] **Step 3: Implement the shared navigation model and drag math**
...
- [ ] **Step 4: Implement an accessible saved-preference theme toggle**
...
- [ ] **Step 5: Implement the safe-area-aware mobile header**
...
- [ ] **Step 6: Mount mobile chrome and update content spacing**
...
- [ ] **Step 7: Tokenize LocaleSwitcher and run tests**
...
- [ ] **Step 8: Commit the shell header unit**
...
- [ ] **Step 1: Extend drag-resolution coverage**
...
- [ ] **Step 2: Replace the full-width bar with the LifeOS dock interaction**
...
- [ ] **Step 3: Render the glossy spring pill and accessible links**
...
- [ ] **Step 4: Keep Register visually primary without changing mechanics**
...
- [ ] **Step 1: Rebuild Sidebar from the shared navigation model**
...
- [ ] **Step 2: Verify route and locale behavior manually**
...
- [ ] **Step 3: Commit the desktop chrome unit**
...
- [ ] **Step 1: Convert Dashboard hierarchy**
...
- [ ] **Step 2: Convert Dashboard mobile action**
...
- [ ] **Step 3: Convert Plan mobile and desktop surfaces**
...
- [ ] **Step 4: Verify both routes in both themes and commit**
...
- [ ] **Step 1: Tokenize SVG axes, tracks, and labels**
...
- [ ] **Step 2: Convert cards and states**
...
- [ ] **Step 3: Verify sparse, empty, and populated rendering**
...
- [ ] **Step 1: Convert Register sections and controls**
...
- [ ] **Step 2: Protect iOS form ergonomics**
...
- [ ] **Step 3: Convert Profile sections and controls**
...
- [ ] **Step 4: Verify native-specific presentation conditions**
...
- [ ] **Step 1: Convert login card and inputs**
...
- [ ] **Step 2: Convert every signup stage**
...
- [ ] **Step 3: Verify keyboard and dark/light rendering and commit**
...
- [ ] **Step 2: Scan for light-only neutral leaks**
...
- [ ] **Step 3: Verify responsive routes in a real browser**
...
- [ ] **Step 4: Exercise the dock interaction matrix**
...
- [ ] **Step 5: Exercise accessibility fallbacks**
...
- [ ] **Step 7: Review diff scope and commit verification fixes**
