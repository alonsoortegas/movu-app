  ...
  return (
    <div className="boot mx-auto max-w-5xl p-4 md:p-8">
      ...
      <div className="glass ticks mb-6 rounded-[1.7rem] border border-[var(--border-hi)] p-5 md:rounded-2xl md:p-4">
        ...
        {isNativeIos && (
          <div className="mb-4 rounded-2xl border border-[var(--border-hi)] bg-[var(--surface)] p-4">
            <div className="flex items-start justify-between gap-3 flex-wrap">
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  <span className="text-lg leading-none">♡</span>
                  <h3 className="text-sm font-semibold text-[var(--text)]">{t("healthkit.title")}</h3>
                </div>
              ...
              <div className="flex flex-col items-end gap-1">
                {healthKitConnected ? (
                  <button type="button" onClick={() => handleHealthKitSync(true)} disabled={healthKitSyncing} className="btn-accent rounded-xl px-4 py-2 text-sm font-semibold disabled:opacity-60">
                    {healthKitSyncing ? t("healthkit.syncing") : t("healthkit.syncNow")}
                  </button>
                ) : (
                  <button type="button" onClick={handleHealthKitConnect} disabled={healthKitSyncing} className="btn-accent rounded-xl px-4 py-2 text-sm font-semibold disabled:opacity-60">
